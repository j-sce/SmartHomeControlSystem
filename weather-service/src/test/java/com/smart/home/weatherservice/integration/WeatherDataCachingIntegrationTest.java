...
import com.smart.home.weatherservice.caching.CacheConfig;
...
import com.smart.home.weatherservice.service.WeatherService;
...
public class WeatherDataCachingIntegrationTest {
    ...
    void whenGetWeatherData_nonExistent_thenCacheNotPopulated_Failure() {
        ...
        assertNull(cacheManager.getCache("weather").get("weather:" + lat + ":" + lon));
        verify(weatherDataClient, times(1)).getWeatherData(lat, lon);
    }
    ...
    void whenMultipleWeatherDataInCache_thenCorrectClosestWeatherKeyReturned() {
        ...
        assertEquals(closestWeatherKey, "weather:54.89178:23.95768");
    }
